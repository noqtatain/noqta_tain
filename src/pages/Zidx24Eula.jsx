...
export default function Zidx24Eula() {
  return (
      ...
      <section className="relative overflow-hidden border-b border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-5 max-w-3xl text-base leading-8 text-slate-600 dark:text-slate-300">
            This End-User License Agreement is a legal agreement between you and Noqtatain for the acquisition and use of the Zidx24 software and related services, which sync orders, customers, and abandoned carts between your Zid store and your Bitrix24 CRM.
          </p>
